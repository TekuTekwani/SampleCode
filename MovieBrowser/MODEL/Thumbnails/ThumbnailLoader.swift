...
extension ThumbnailLoader{
    func observeLowMemoryNotification(){
        NotificationCenter.default.addObserver(self, selector: #selector(didReceiveLowMemoryWarning), name: UIApplication.didReceiveMemoryWarningNotification, object: nil)
    }
